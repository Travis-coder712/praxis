...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    summary:
      'How Copilot M365 actually works. Web vs Word vs Excel vs Outlook vs Teams. Work mode vs Web mode. The permissions and data plane. Source-document workflows (where Copilot shines). Agents.',
    accent: '#0ea5e9',
    status: 'planned',
    lessons: [
      { id: 'what-copilot-actually-is', number: 1, title: 'What Copilot M365 actually is',              summary: 'OpenAI model + Microsoft Graph + your tenant. The three-part stack explained.', readingTime: '8 min', status: 'planned' },
      { id: 'copilot-everywhere',       number: 2, title: 'Copilot in Word / Excel / PowerPoint / Outlook / Teams', summary: 'What changes per app. Where the surface differs.',                       readingTime: '10 min', status: 'planned' },
      { id: 'chat-vs-app',              number: 3, title: 'Copilot Chat (web) vs Copilot in apps',      summary: 'Same brain, different reach. When to use which.',                           readingTime: '7 min', status: 'planned' },
      { id: 'work-vs-web',              number: 4, title: 'Work mode vs Web mode',                     summary: 'The toggle most people miss — and why it matters.',                          readingTime: '6 min', status: 'planned' },
      { id: 'permissions',              number: 5, title: 'Permissions and the data plane',            summary: 'What Copilot can see, what it can\'t, who else can see your prompts.',         readingTime: '9 min', status: 'planned' },
      { id: 'source-documents',         number: 6, title: 'Source-document workflows',                 summary: 'The killer Copilot use case — summarising and integrating across documents.', readingTime: '10 min', status: 'planned' },
      { id: 'agents',                   number: 7, title: 'Copilot agents',                            summary: 'Email triage, calendar, custom — what they do and when they work.',           readingTime: '8 min', status: 'planned' },
      { id: 'progressive-difficulty',   number: 8, title: 'Ten progressively-harder Copilot tasks',    summary: 'A workout — easy to advanced.',                                                readingTime: '15 min', status: 'planned' },
    ],
  },
  {
    id: 'claude-deep-dive',
